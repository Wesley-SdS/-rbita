...
export const SETTING_DEFS = {
  ...
  "graph.arquivarConversas": bool(
    ...
    "Conversa que terminou vira parte do que a Órbita pode consultar depois (\"aquele papo sobre realtime\"). Desligado, só documentos e reuniões entram.",
    true,
  ),
  "graph.conversaParadaMinutos": num(
    "graph",
    "Guardar a conversa depois de parada por",
    "Conversa em andamento não é arquivada: seria reindexar a cada mensagem nova, e o embedding custa.",
    30,
    5,
    1440,
    { unit: "min" },
  ),
  "graph.minimoDeMensagens": num(
    "graph",
    "Mínimo de mensagens para guardar",
    "Abaixo disso a conversa é considerada ruído (um \"oi\" e um \"olá\" não são conhecimento).",
    4,
    2,
    50,
  ),
